...
const travelPlacesArray = [
  {
    name: 'Austin',
    image: 'http://cdn.destination360.com/north-america/us/texas/images/s/austin-day-trip.jpg',
    description: 'Mount Bonnell is the peak within Covert Park located on Mount Bonnell Drive and offers public access to panoramic views several hundred feet above Lake Austin'
  },
  {
    name: 'Austin',
    image: 'http://cdn.destination360.com/north-america/us/texas/images/s/austin-day-trip.jpg',
      ...
      travelPlacesArray.map(travelPlace => {
        TravelClub.create(travelPlace, (err, travelPlace) => {
          if(err) console.log(err);
            ...
            Comment.create({ text: 'This place is beautiful', author: 'John Doe' }, (err, comment) => {
              if(err) console.log(err);
